...
const MerchantPortal = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Load products
      const productsResponse = await fetch('http://127.0.0.1:5000/api/merchants/products/', {
        headers: {
      ...
      // Load orders
      const ordersResponse = await fetch('http://127.0.0.1:5000/api/merchants/orders/', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        },
      ...
      // Load analytics
      const analyticsResponse = await fetch('http://127.0.0.1:5000/api/merchants/dashboard/', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        },
  ...
  const handleSearch = async () => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:5000/api/merchants/products/?${params}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        },
  ...
  const handleToggleProductStatus = async (productId) => {
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`http://127.0.0.1:5000/api/merchants/products/${productId}/toggle_active/`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleUpdateStock = async (productId, newQuantity) => {
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`http://127.0.0.1:5000/api/merchants/products/${productId}/update_stock/`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleDeleteProduct = async (productId) => {
    if (window.confirm('Are you sure you want to delete this product?')) {
      try {
        const token = localStorage.getItem('access_token');
        const response = await fetch(`http://127.0.0.1:5000/api/merchants/products/${productId}/`, {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleUpdateOrderStatus = async (orderId, newStatus) => {
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`http://127.0.0.1:5000/api/merchants/orders/${orderId}/update_status/`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleViewOrderDetails = async (orderId) => {
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`http://127.0.0.1:5000/api/merchants/orders/${orderId}/details/`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        },
